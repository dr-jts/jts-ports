...
public class ConcaveHullExcavator {
   ...
   */
  public static Geometry computeZero(Geometry geom) {
  ...
  public static Geometry compute(Geometry geom, double lengthThreshold) {
    return computeConcavity(geom, lengthThreshold, defaultConcavity);
  }
   ...
   */
  public static Geometry computeConcavity(Geometry geom, double lengthThreshold, double concavity)
  {
